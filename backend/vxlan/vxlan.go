...
//   the kernal vxlan codeto the flannel daemon to get the public IP that should be used for that VTEP (this gets called
...
// listening for any netlink messages anymore. This improves reliability (no worries about things timing out if
// flannel crashes or restarts) and simplifies upgrades.
//
// How it works:
// Create the vxlan device but don't register for any L*MISS messages
...
// Create the vxlan device, grab a lease configure a host route and return a backend.Network
